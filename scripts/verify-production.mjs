...
async function verify() {
  ...
  if (!essay.includes('The League That Left No Map')) throw new Error('Hanseatic essay assertion failed');
  if (/Phase 0 fixture/i.test(essay)) throw new Error('stale Phase 0 fixture label survives in Hanseatic essay');
