...
const RAW: unknown[] = [
  ...
  { id: 'waldseemuller', title: 'Waldseemüller World Map', year: 1507, essaySlug: 'speculum', region: 'Saint-Dié', coords: [6.94, 48.28], blurb: 'The map that first wrote "America".', cartographer: 'Martin Waldseemüller', cartographerId: 'waldseemuller' },
  { id: 'ortelius', title: 'Ortelius Theatrum', year: 1570, essaySlug: 'speculum', region: 'Antwerp', coords: [4.4, 51.22], blurb: 'The first modern atlas — the world bound as a book.', cartographer: 'Abraham Ortelius', cartographerId: 'ortelius' },
  ...
  { id: 'honterus', title: "Honterus' Transylvania", year: 1532, essaySlug: 'dacia', region: 'Transylvania', coords: [25.6, 45.65], blurb: 'A humanist maps his own Carpathian homeland.', cartographer: 'Johannes Honterus', cartographerId: 'honterus' },
